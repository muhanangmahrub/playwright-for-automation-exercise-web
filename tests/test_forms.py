...
def test_contact_us_form(page: Page, home):
    ...
    expect(home.automation_exercise_heading).to_be_visible()
...
def test_verify_subscription_in_home_page(page: Page, home):
    ...
    expect(home.footer.subscription_heading).to_be_visible()
    home.footer.subscribe("emailtest@gmail.com")
    expect(home.footer.subscription_success_message).to_be_visible()
